...
export default function ChangePassword() {
    ...
    .refine((data) => data.newpassword === data.confirmed_newpassword, {
        message: "Passwords do not match",
        path: ["confirmed_newpassword"],
    })
    ;
              ...
              <div className='w-full flex justify-center'>
                ...
                <form onSubmit={handleSubmit(SubmitForm)}>
                  ...
                  <div className="mb-4">
                    ...
                    {errors?.oldpassword && <span className='text-primary'>{errors.oldpassword.message}</span>}
                  ...
                  <div className="mb-4">
                    ...
                    {errors?.newpassword && <span className='text-primary'>{errors.newpassword.message}</span>}
                    <div className="relative">
                      <input
                  ...
                  <div className="mb-4">
                    ...
                    {errors?.confirmed_newpassword && <span className='text-primary'>{errors.confirmed_newpassword.message}</span>}
                    <div className="relative">
                      <input
                        {...register("confirmed_newpassword")}
                  ...
                  <div className="mb-5">
                    <input
                      ...
                      className={`w-full cursor-pointer rounded-lg border border-primary p-4 text-white transition bg-primary` }
                    />
                  </div>
                  {isChanged&&<Navigate to={'/'}/>}
                </form>
              </div>
            </div>
          </div>
